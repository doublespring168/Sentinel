package top.doublespring.utils;


import com.alibaba.fastjson.JSON;
import top.doublespring.commonMessage.MsgType;
import top.doublespring.commonMessage.ResponseMessage;
import top.doublespring.exception.BizException;
import top.doublespring.exception.ServiceException;
...
public class U {
    ...
    public static boolean isBlank(Object obj) {
        return Objects.isNull(obj) || "null".equalsIgnoreCase(obj.toString().trim());
    }
    ...
    public static BizException throwBizException(String msg, Throwable t) {
        return new BizException(msg, t);
    }

    public static BizException throwBizException(Throwable t) {
